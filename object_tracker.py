    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            if FLAGS.fourcounter:
                ...
                x4, y4 = 175, 330
                x5, y5 = 190, 220
                cv2.line(frame, (x3, y3), (x4, y4), (255, 255, 0), 10)
                cv2.line(frame, (x4, y4), (x5, y5), (255, 200, 0), 10)
                cv2.putText(frame,('Leg 2'),(x3+20,y3+20), cv2.FONT_HERSHEY_COMPLEX_SMALL,0.8,(255,255,0),2)

                #Red Line
                x6, y6 = 380,50
                x7, y7 = 540,25
                x8, y8 = 680,10
                cv2.line(frame, (x6, y6), (x7, y7), (255, 0, 0), 10)
                cv2.line(frame, (x7, y7), (x8, y8), (200, 0, 0), 10)
                cv2.putText(frame,('Leg 3'),(x6+20,y6+20), cv2.FONT_HERSHEY_COMPLEX_SMALL,0.8,(255,0,0),2)

                #Green Line
                x8, y8 = 1040,160
                x9, y9 = 1090,320
                x10, y10 = 1130,420
                cv2.line(frame, (x8, y8), (x9, y9), (0, 255, 0), 10)
                cv2.line(frame, (x9, y9), (x10, y10), (0, 200, 0), 10)
                cv2.putText(frame,('Leg 4'),(x8+20,y8+20), cv2.FONT_HERSHEY_COMPLEX_SMALL,0.8,(0,255,0),2)
                ...
                leg3in = LineString([(x6, y6), (x7, y7)])
                leg3out = LineString([(x7, y7), (x8, y8)])
                leg4in = LineString([(x8, y8), (x9, y9)])
                leg4out = LineString([(x9, y9), (x10, y10)])
                ...
                draw_text_position1 = (int(width*0.10), int(height*0.98))
                draw_text_position2 = (int(width*0.15), int(height*0.05))
                ...
                #cv2.putText(frame, f'From Leg 2 to Leg 4', (5, 305), 0, 1, [225, 255, 255], thickness=2, lineType=cv2.LINE_AA)
                #cv2.putText(frame, f'From Leg 4 to Leg 2', (width - 350, 305), 0, 1, [225, 255, 255], thickness=2, lineType=cv2.LINE_AA)

                #idx = 0
                #for class_name, count in class_counter_2enter4.items():
                ...
                #idx = 0
                #for class_name, count in class_counter_4enter2.items():
